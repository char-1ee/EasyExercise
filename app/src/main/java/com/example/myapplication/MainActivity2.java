            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (id) {
                    case R.id.navigation_plans:
                        Intent intent1;
                        intent1 = new Intent(MainActivity2.this, ViewHistory.class);
                        startActivity(intent1);
                        return true;
                    case R.id.navigation_community:
                        Intent intent2;
                        intent2 = new Intent(MainActivity2.this, ViewHistory.class);
                        startActivity(intent2);
                        return true;
                    case R.id.navigation_me:
                        Intent intent3;
                        intent3 = new Intent(MainActivity2.this, ViewHistory.class);
