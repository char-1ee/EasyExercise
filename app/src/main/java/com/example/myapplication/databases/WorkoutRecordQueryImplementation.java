...
public class WorkoutRecordQueryImplementation {
    ...
    @Override
    public void createRecord(WorkoutRecord workoutRecord, QueryResponse<Boolean> response) {
        SQLiteDatabase sqLiteDatabase = databaseHelper.getWritableDatabase();

        ContentValues contentValues = getContentValuesForStudent(workoutRecord);
    ...
    @Override
    public void readStudent(int workoutRecordId, QueryResponse<WorkoutRecord> response) {
    ...
    private ContentValues getContentValuesForStudent(WorkoutPlan workoutPlan){
